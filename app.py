...
lebron_regular_season = pd.read_csv("data/lebron_career.csv",parse_dates=["date"])
...
jordan_regular_season = pd.read_csv("data/jordan_career.csv",parse_dates=["date"])
...
#playoffs import
lebron_playoffs = pd.read_csv("data/lebron_playoffs.csv",parse_dates=["date"])
...
jordan_playoffs = pd.read_csv("data/jordan_playoffs.csv",parse_dates=["date"])
